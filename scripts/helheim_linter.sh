...
if grep -q "var_store" "$(dirname "$0")/../helheim-core/src/orchestra/mod.rs"; then
...
if grep -q "try_execute_native" "$(dirname "$0")/../helheim-core/src/orchestra/executor.rs" | grep -v "system::SystemManager"; then
