...
impl Parser {
    pub fn parse(source: &str) -> Result<HelProgram> {
        ...
        for line in source.lines() {
            ...
            if clean.contains("MATERIE {") { continue; }
            ...
            if in_stroom {
                ...
                if clean.contains("MATMUL") {
                    ...
                    program.stroom.push(CodeTaal::MatMul { m: 1024, n: 1024, k: 1024 });
                } else if clean.contains("CHAOS") {
                    program.stroom.push(CodeTaal::Chaos { intensity: 100, duration_ms: 1000 });
